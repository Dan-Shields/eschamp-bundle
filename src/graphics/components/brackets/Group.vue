...
import bg from '../../assets/Brackets/Group_Lines.png'
...
const group = searchParams.get('group')?.toUpperCase() ?? 'A'

const bracket = useReplicant(`group${group}Bracket`, 'eschamp-bundle', {
    defaultValue: repDefaults.groupBracket,
})
